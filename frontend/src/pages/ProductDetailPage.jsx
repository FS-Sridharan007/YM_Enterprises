  ...
  if (!product) {
    return (
      <div className="container mx-auto px-6 py-32 text-center">
        ...
        <Link
          to="/products"
          className="mt-8 inline-block bg-brand-gold text-brand-teal font-bold py-3 px-6 rounded-md"
        >
          Back to Products
        </Link>
      </div>
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <Link
          ...
          className="flex items-center text-brand-teal hover:text-brand-gold mb-8 font-medium"
        >
        ...
        <div className="flex flex-col items-start">
          ...
          {/* Image Card */}
          <div className="bg-gray-100 rounded-xl shadow-lg p-4 w-full max-w-md">
            <div className="w-full h-[350px] rounded-lg overflow-hidden flex items-center justify-center">
              <img
                src={mainImage}
                alt={product.title}
          ...
          <Link
            ...
            className="mt-6 bg-brand-gold text-brand-charcoal font-bold px-8 py-3 rounded-xl hover:bg-yellow-400 transition"
          >
            Buy Now
          </Link>
        </div>
